# File: Medical complications set up - 2005 
# Date: 11/30/2023
...
bsmf_2005 <- readr::read_fwf(here("data", "raw", "2000_2005","Nigra_BSMF_2005.dat"),
...
bsmf_2005 <- bsmf_2005 %>% 
  mutate(last_liv_date = str_replace(last_liv_date, "(^\\s+)|(\\s+$)", ""), #get rid of breakspace at beginning and end
         ...
         last_liv_date = ifelse(as.numeric(last_liv_date) > 2006, NA, last_liv_date)) #removes errors after dataset date
...
bsmf <- bind_cols(bsmf_2005, preg_2005, labor_2005)

write.csv(bsmf, file= here("data","intermediate","bsmf_2005_int.csv"))