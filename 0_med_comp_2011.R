# File: Medical complications set up - 2011
# Date: 11/30/2023
...
bsmf_2011 <- readr::read_fwf(here("data", "raw", "2011_2017","Nigra_BSMF_2011.dat"),
                             fwf_cols(ch_sex=c(58), plural=c(61), plural_ord=c(62),
                                      weight=c(63, 66), birthdate=c(67, 74), hosp_code=c(75, 78), #these are the breakspaces for where the column begins and ends
                                      birth_countyplace=c(79, 81), mom_birthplace=c(97, 99), 
                                      mom_age=c(100, 101), mom_years_edu=c(102), 
                                      mom_res_county=c(103, 105), apgar1=c(106, 107),
                                      apgar5=c(108, 109), apgar10=c(110, 111),
                                      ...
                                      ch_total_ever=c(163, 164), last_liv_date=c(165, 170),  
                                      ...
                                      mom_state=c(292, 293), 
                                      fath_eth1=c(341, 342), fath_eth2=c(343, 344), 
                                      fath_eth3=c(345, 346), 
...
bsmf_2011 <- bsmf_2011 %>% 
  mutate(last_liv_date = str_replace(last_liv_date, "(^\\s+)|(\\s+$)", ""), #get rid of breakspace at beginning and end
         ...
         last_liv_date = ifelse(as.numeric(last_liv_date) > 2012, NA, last_liv_date)) #removes errors after dataset date
...
bsmf <- bind_cols(bsmf_2011, preg_2011, labor_2011)

write.csv(bsmf, file= here("data","intermediate","bsmf_2011_int.csv"))