# File: Medical complications set up - 2003
# Date: 11/30/2023
...
bsmf_2003 <- readr::read_fwf(here("data", "raw", "2000_2005","Nigra_BSMF_2003.dat"),
...
bsmf_2003 <- bsmf_2003 %>% 
  mutate(last_liv_date = str_replace(last_liv_date, "(^\\s+)|(\\s+$)", ""), #get rid of breakspace at beginning and end
         ...
         last_liv_date = ifelse(as.numeric(last_liv_date) > 2004, NA, last_liv_date)) #removes errors after dataset date
...
bsmf <- bind_cols(bsmf_2003, preg_2003, labor_2003)

write.csv(bsmf, file= here("data","intermediate","bsmf_2003_int.csv"))