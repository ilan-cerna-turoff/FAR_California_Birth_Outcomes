# File: Medical complications set up - 2001
# Date: 11/30/2023
...
bsmf_2001 <- readr::read_fwf(here("data", "raw", "2000_2005","Nigra_BSMF_2001.dat"),
...
bsmf_2001 <- bsmf_2001 %>% 
  mutate(last_liv_date = str_replace(last_liv_date, "(^\\s+)|(\\s+$)", ""), #get rid of breakspace at beginning and end
         ...
         last_liv_date = ifelse(as.numeric(last_liv_date) > 2002, NA, last_liv_date)) #removes errors after dataset date
...
bsmf <- bind_cols(bsmf_2001, preg_2001, labor_2001)

write.csv(bsmf, file= here("data","intermediate","bsmf_2001_int.csv"))